// ==UserScript==
// @name         Torn: Car skins library
// @namespace    brainslug.cars
// @author       Brainslug
// @version      0.0.1
// @description  Library of car items and available skins.
// ==/UserScript==

/**
 * Note:
 * These lists are not actually used in the script but it's a good 
 * lookup table for updating the json since that only contains the 
 * necessary id's and unfortunately json doesn't support comments
 */
